...
|2              |[](/)|Создал таблицы и внёс в них данные.<br>Рассчитал: размер прибыли по возрастным группам по месяцам, определил месяц с максимальной выручкой определённой возрастной группы, товар приносящий максимальное количество прибыли, топ-3 товаров приносящих макис|`postgres` `SQL`|
