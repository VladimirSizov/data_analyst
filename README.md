...
|3              |[Сбор данных из открытых источников](collection_data_open_sources/)|Это пример некоторых методов получения данных из Google Trends и записи в собственную БД sqlite3|`pytrends` `sqlite3` `pandas` `datetime` `zoneinfo` `re`|
